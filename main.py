...
def analyze_misinformation_impact(query):
...
Analyze the potential impact of this misinformation:

1. What emotions might it trigger? (fear, anger, confusion, etc.)
2. How could it influence public sentiment?
3. What societal consequences could arise?
4. Could it affect politics, economy, health, or social stability?
...
def run(query):
    ...
    # -------- If FALSE → Analyze Impact --------
    if "FALSE" in result.upper():
        print("\n============== MISINFORMATION IMPACT ANALYSIS ==============\n")
        impact_analysis = analyze_misinformation_impact(query)
    ...
    print(f"Final Aggregated Credibility Score: {credibility_score}")
